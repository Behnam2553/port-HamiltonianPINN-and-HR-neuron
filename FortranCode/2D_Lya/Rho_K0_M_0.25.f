...
C       COMMON/c5/z_tau,Tau
        ...
        Open(7,File="Lya_rho_k_m_0.25.txt",Status='unknown')
        Open(8,File="Max_Lya_rho_k_m_0.25.txt",Status='unknown')
C
        N=5
        NN=(N*N)+N
C
...
c
        ...
        DO WHILE (Rho .LE. 0.90D0)
          K0  = -2.50 D0
           DO WHILE (K0 .LE. 1.50D0)
...
C
        ...
        END DO
        WRITE(7,*)Rho, EXPO(1), EXPO(2), EXPO(3), EXPO(4), EXPO(5)
        WRITE(8,*)Rho,MAX(EXPO(1),EXPO(2),EXPO(3),EXPO(4),EXPO(5)),K0
